...
import (
	...
	simpleiov1beta1 "github.com/greatlazyman/apiserver/pkg/apis/client/listers/simple.io/v1beta1"
	apissimpleiov1beta1 "github.com/greatlazyman/apiserver/pkg/apis/simple.io/v1beta1"
...
type FooInformer interface {
	...
	Lister() simpleiov1beta1.FooLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SimpleV1beta1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SimpleV1beta1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&apissimpleiov1beta1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apissimpleiov1beta1.Foo{}, f.defaultInformer)
}

func (f *fooInformer) Lister() simpleiov1beta1.FooLister {
	return simpleiov1beta1.NewFooLister(f.Informer().GetIndexer())
}
