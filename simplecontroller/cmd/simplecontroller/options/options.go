...
func NewOptions() *Options {
	return &Options{
		LeaderElection: componentbaseconfig.LeaderElectionConfiguration{
			...
			ResourceNamespace: constants.DefaultNamespace,
			ResourceName:      "simplecontroller",
...
func (o *Options) AddFlags(flags *pflag.FlagSet) {
	...
	flags.StringVar(&o.LeaderElection.ResourceName, "leader-elect-resource-name", "simplecontroller", "The name of resource object that is used for locking during leader election.")
	flags.StringVar(&o.LeaderElection.ResourceNamespace, "leader-elect-resource-namespace", constants.DefaultNamespace, "The namespace of resource object that is used for locking during leader election.")
