...
func IsRandomfullySupported(ctx context.Context, nftv4 knftables.Interface) bool {
	log.Info("check is randomfully supported")
	result := true
	tx := nftv4.NewTransaction()
