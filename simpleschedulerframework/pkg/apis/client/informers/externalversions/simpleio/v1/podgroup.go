	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SimpleV1().PodGroups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SimpleV1().PodGroups(namespace).Watch(context.TODO(), options)
			},
		},
		&simpleiov1.PodGroup{},
		resyncPeriod,
...
func (f *podGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&simpleiov1.PodGroup{}, f.defaultInformer)
}
