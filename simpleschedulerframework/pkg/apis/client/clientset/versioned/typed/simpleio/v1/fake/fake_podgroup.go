...
func (c *FakePodGroups) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.PodGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(podgroupsResource, c.ns, name), &v1.PodGroup{})
...
func (c *FakePodGroups) List(ctx context.Context, opts metav1.ListOptions) (result *v1.PodGroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(podgroupsResource, podgroupsKind, c.ns, opts), &v1.PodGroupList{})
...
func (c *FakePodGroups) Create(ctx context.Context, podGroup *v1.PodGroup, opts metav1.CreateOptions) (result *v1.PodGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(podgroupsResource, c.ns, podGroup), &v1.PodGroup{})
...
func (c *FakePodGroups) Update(ctx context.Context, podGroup *v1.PodGroup, opts metav1.UpdateOptions) (result *v1.PodGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(podgroupsResource, c.ns, podGroup), &v1.PodGroup{})
...
func (c *FakePodGroups) UpdateStatus(ctx context.Context, podGroup *v1.PodGroup, opts metav1.UpdateOptions) (*v1.PodGroup, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(podgroupsResource, "status", c.ns, podGroup), &v1.PodGroup{})
...
func (c *FakePodGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.PodGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(podgroupsResource, c.ns, name, pt, data, subresources...), &v1.PodGroup{})
